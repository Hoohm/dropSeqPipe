...
first = 'snakemake -s snakefiles/Dropseq_pre_align.snake --cores 8 -pT -d {} --configfile local.json'.format(sys.argv[1])
second = 'snakemake -s snakefiles/Star_align.snake --cores 8 -pT -d {} --configfile local.json'.format(sys.argv[1])
third = 'snakemake -s snakefiles/Dropseq_post_align.snake --cores 8 -pT -d {} --configfile local.json'.format(sys.argv[1])
